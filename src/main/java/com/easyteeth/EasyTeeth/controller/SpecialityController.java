...
public class SpecialityController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Optional<Speciality>> getSpeciality(@PathVariable("id") Long idSpeciality)
			throws IOException {
	...
	@GetMapping("/index")
	public ResponseEntity<List<Speciality>> getAll() throws IOException {
